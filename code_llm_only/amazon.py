...
config = {
    ...
    "output_path": "dataset/open_llm/amazon_qwen7b_only.json",
    "vectdb_path": "database/amazon",
    "template": {
        "sys": "prompts/system/amazon/llm_only.txt",
        "user": "prompts/user/amazon/llm_only.txt"
    },
}
...
potential_level1 = "**" + "**, **".join(df["Cat1"].unique()) + "**"
potential_level2 = "**" + "**, **".join(df["Cat2"].unique()) + "**"
potential_level3 = "**" + "**, **".join(df["Cat3"].unique()) + "**"
